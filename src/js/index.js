        ...
        success:function(data){
            ...
            for(var i=0;i<data.length;i++){
                if(apiTarget=='skill'){
                    ...
                    html += '<li class="project"><div class="title"><h2>'+data[i].name+'</h2><p>'+data[i].category+'</p></div><div class="project_img"><img src="'+data[i].image+'"></div><div class="description">'+data[i].description+'</div><div class="detail">'+data[i].detail+'</div><div class="project_footer"><div class="tech"><img src="images/bootstrap.png" style="width: 8vw;"/><img src="images/jquery.png" style="width: 8vw;"/></div><div class="link"><a target="_blank" href="'+data[i].url+'">Try it</a></div></div></li>';
                    $('#header h2').html('项目');
